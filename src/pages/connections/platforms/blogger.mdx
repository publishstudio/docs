...
If you would like to remove connection simply click **Disconnect**. Additionally, you might also want to revoke access from your [Google account settings](https://pbst.link/google-3rd-apps).
