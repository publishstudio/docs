...
If you would like to remove connection simply click **Disconnect**. Additionally, you might also want to revoke access from your [Google account settings](https://myaccount.google.com/connections).
